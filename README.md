...
**Think of it as a fashion shoe store with a brain.**

This is a full-featured e-commerce platform where customers can:

- 👠 **Browse & Buy** — Shop premium shoes and fashion items with real-time stock updates
- 🤖 **Chat with AI** — Ask the AI assistant to find shoes, check prices, or track orders
...
export const searchProductsTool = tool({
  description: "Search for shoes in the fashion store",
