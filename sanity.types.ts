...
export type Product = {
  ...
  color?: "black" | "white" | "off-white" | "cream" | "beige" | "ivory" | "grey" | "light-grey" | "charcoal" | "silver" | "red" | "crimson" | "burgundy" | "maroon" | "coral" | "pink" | "hot-pink" | "rose" | "blush" | "orange" | "rust" | "terracotta" | "peach" | "yellow" | "mustard" | "gold" | "lime" | "green" | "olive" | "forest-green" | "mint" | "sage" | "teal" | "blue" | "navy" | "sky-blue" | "royal-blue" | "denim" | "cobalt" | "purple" | "lavender" | "violet" | "plum" | "lilac" | "brown" | "tan" | "camel" | "oak" | "walnut" | "natural" | "multicolor";
  dimensions?: string;
  images?: Array<{
    asset?: {
      _ref: string;
...
// Query: *[  _type == "order"  && _id == $id][0] {  _id,  orderNumber,  clerkUserId,  email,  items[]{    _key,    quantity,    priceAtPurchase,    product->{      _id,      name,      "slug": slug.current,      "image": images[0]{        asset->{ _id, url }      }    }  },  total,  status,  address{    name,    phone,    line1,    line2,    city,    state,    postcode,    country  },  paystackPaymentId,  createdAt}
...
// Variable: ORDER_BY_PAYSTACK_PAYMENT_ID_QUERY
// Query: *[  _type == "order"  && paystackPaymentId == $paystackPaymentId][0]{ _id }
export type ORDER_BY_PAYSTACK_PAYMENT_ID_QUERYResult = {
  _id: string;
} | null;
...
export type ALL_PRODUCTS_QUERYResult = Array<{
  ...
  color: "beige" | "black" | "blue" | "blush" | "brown" | "burgundy" | "camel" | "charcoal" | "cobalt" | "coral" | "cream" | "crimson" | "denim" | "forest-green" | "gold" | "green" | "grey" | "hot-pink" | "ivory" | "lavender" | "light-grey" | "lilac" | "lime" | "maroon" | "mint" | "multicolor" | "mustard" | "natural" | "navy" | "oak" | "off-white" | "olive" | "orange" | "peach" | "pink" | "plum" | "purple" | "red" | "rose" | "royal-blue" | "rust" | "sage" | "silver" | "sky-blue" | "tan" | "teal" | "terracotta" | "violet" | "walnut" | "white" | "yellow" | null;
...
// Query: *[  _type == "product"  && category->slug.current == $categorySlug] | order(name asc) {  _id,  name,  "slug": slug.current,  price,  "image": images[0]{    asset->{      _id,      url    },    hotspot  },  category->{    _id,    title,    "slug": slug.current  },  material,  colors,  stock}
...
// Variable: RELATED_PRODUCTS_BY_CATEGORY_QUERY
// Query: *[  _type == "product"  && category->slug.current == $categorySlug  && _id != $productId  && stock > 0] | order(name asc) [0...4] {  _id,  name,  "slug": slug.current,  price,  "images": images[0...4]{    _key,    asset->{      _id,      url    }  },  category->{    _id,    title,    "slug": slug.current  },  sizes,  colors,  stock}
export type RELATED_PRODUCTS_BY_CATEGORY_QUERYResult = Array<{
  _id: string;
  name: string | null;
  slug: string | null;
  price: number | null;
...
// Query: *[  _type == "product"  && ($categorySlug == "" || category->slug.current == $categorySlug)  && ($color == "" || $color in colors)  && ($size == "" || $size in sizes)  && ($minPrice == 0 || price >= $minPrice)  && ($maxPrice == 0 || price <= $maxPrice)  && ($searchQuery == "" || name match $searchQuery + "*" || description match $searchQuery + "*")  && ($inStock == false || stock > 0)] | order(name asc) {  _id,  name,  "slug": slug.current,  price,  "images": images[0...4]{    _key,    asset->{      _id,      url    }  },  category->{    _id,    title,    "slug": slug.current  },  sizes,  colors,  stock}
...
// Query: *[  _type == "product"  && ($categorySlug == "" || category->slug.current == $categorySlug)  && ($color == "" || $color in colors)  && ($size == "" || $size in sizes)  && ($minPrice == 0 || price >= $minPrice)  && ($maxPrice == 0 || price <= $maxPrice)  && ($searchQuery == "" || name match $searchQuery + "*" || description match $searchQuery + "*")  && ($inStock == false || stock > 0)] | order(price asc) {  _id,  name,  "slug": slug.current,  price,  "images": images[0...4]{    _key,    asset->{      _id,      url    }  },  category->{    _id,    title,    "slug": slug.current  },  sizes,  colors,  stock}
...
// Query: *[  _type == "product"  && ($categorySlug == "" || category->slug.current == $categorySlug)  && ($color == "" || $color in colors)  && ($size == "" || $size in sizes)  && ($minPrice == 0 || price >= $minPrice)  && ($maxPrice == 0 || price <= $maxPrice)  && ($searchQuery == "" || name match $searchQuery + "*" || description match $searchQuery + "*")  && ($inStock == false || stock > 0)] | order(price desc) {  _id,  name,  "slug": slug.current,  price,  "images": images[0...4]{    _key,    asset->{      _id,      url    }  },  category->{    _id,    title,    "slug": slug.current  },  sizes,  colors,  stock}
...
// Query: *[  _type == "product"  && ($categorySlug == "" || category->slug.current == $categorySlug)  && ($color == "" || $color in colors)  && ($size == "" || $size in sizes)  && ($minPrice == 0 || price >= $minPrice)  && ($maxPrice == 0 || price <= $maxPrice)  && ($searchQuery == "" || name match $searchQuery + "*" || description match $searchQuery + "*")  && ($inStock == false || stock > 0)] | score(  boost(name match $searchQuery + "*", 3),  boost(description match $searchQuery + "*", 1)) | order(_score desc, name asc) {  _id,  name,  "slug": slug.current,  price,  "images": images[0...4]{    _key,    asset->{      _id,      url    }  },  category->{    _id,    title,    "slug": slug.current  },  sizes,  colors,  stock}
...
// Variable: PRICE_RANGE_QUERY
// Query: {  "minPrice": *[_type == "product" && stock > 0] | order(price asc) [0].price,  "maxPrice": *[_type == "product" && stock > 0] | order(price desc) [0].price}
export type PRICE_RANGE_QUERYResult = {
  minPrice: number | null;
  maxPrice: number | null;
};
// Variable: AI_SEARCH_PRODUCTS_QUERY
// Query: *[  _type == "product"  && (    $searchQuery == ""    || name match $searchQuery + "*"    || description match $searchQuery + "*"    || category->title match $searchQuery + "*"  )  && ($categorySlug == "" || category->slug.current == $categorySlug)  && ($size == "" || dimensions == $size)  && ($color == "" || color == $color)  && ($minPrice == 0 || price >= $minPrice)  && ($maxPrice == 0 || price <= $maxPrice)] | order(name asc) [0...20] {  _id,  name,  "slug": slug.current,  description,  price,  "image": images[0]{    asset->{      _id,      url    }  },  category->{    _id,    title,    "slug": slug.current  },  material,  color,  dimensions,  stock,  featured,  assemblyRequired}
...
declare module "@sanity/client" {
  interface SanityQueries {
    ...
    "*[\n  _type == \"order\"\n  && paystackPaymentId == $paystackPaymentId\n][0]{ _id }": ORDER_BY_PAYSTACK_PAYMENT_ID_QUERYResult;
    "*[\n  _type == \"product\"\n] | order(name asc) {\n  _id,\n  name,\n  \"slug\": slug.current,\n  description,\n  price,\n  \"images\": images[]{\n    _key,\n    asset->{\n      _id,\n      url\n    },\n    hotspot\n  },\n  category->{\n    _id,\n    title,\n    \"slug\": slug.current\n  },\n  material,\n  color,\n  dimensions,\n  stock,\n  featured,\n  assemblyRequired\n}": ALL_PRODUCTS_QUERYResult;
    "*[\n  _type == \"product\"\n  && featured == true\n  && stock > 0\n] | order(name asc) [0...6] {\n  _id,\n  name,\n  \"slug\": slug.current,\n  description,\n  price,\n  \"images\": images[]{\n    _key,\n    asset->{\n      _id,\n      url\n    },\n    hotspot\n  },\n  category->{\n    _id,\n    title,\n    \"slug\": slug.current\n  },\n  stock\n}": FEATURED_PRODUCTS_QUERYResult;
    "*[\n  _type == \"product\"\n  && category->slug.current == $categorySlug\n] | order(name asc) {\n  _id,\n  name,\n  \"slug\": slug.current,\n  price,\n  \"image\": images[0]{\n    asset->{\n      _id,\n      url\n    },\n    hotspot\n  },\n  category->{\n    _id,\n    title,\n    \"slug\": slug.current\n  },\n  material,\n  colors,\n  stock\n}": PRODUCTS_BY_CATEGORY_QUERYResult;
    "*[\n  _type == \"product\"\n  && category->slug.current == $categorySlug\n  && _id != $productId\n  && stock > 0\n] | order(name asc) [0...4] {\n  _id,\n  name,\n  \"slug\": slug.current,\n  price,\n  \"images\": images[0...4]{\n    _key,\n    asset->{\n      _id,\n      url\n    }\n  },\n  category->{\n    _id,\n    title,\n    \"slug\": slug.current\n  },\n  sizes,\n  colors,\n  stock\n}": RELATED_PRODUCTS_BY_CATEGORY_QUERYResult;
